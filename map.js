...
function styleHomicidios(feature) {
    return {
        weight: .75,
        opacity: 0.5,
        color: 'grey',
        dashArray: '0',
        fillOpacity: 0.9,
        fillColor: choroplethize(feature.properties.homicidios2015_Grand_Total)
    }
}
...
var Homicidios2015Layer = L.geoJSON([homicidios2015], {
    style: styleHomicidios,
    onEachFeature: geojsonPopupHomicidios,
    pointToLayer: function (feature, latlng) {
        return L.marker(latlng);
    }
});
...
function geojsonPopupHomicidios(feature, layer) {
    if (feature.properties.NOMLOC != null) {
        layer.bindPopup('Municipio:   ' + feature.properties.NOMLOC + '<br>Homicidios en 2015:   ' + feature.properties.homicidios2015_Grand_Total);
    }
}
